...
const Navbar = ({ page }: PageProps) => {
  ...
  return (
    <nav
      className={`${
        page !== "home" ? "sticky top-0 z-50 bg-gray-100 bg-opacity-90" : ""
      }`}
    >
      <div
        className={`px-[15px] py-3 md:flex justify-evenly ${
          page === "home" && "shadow-gray-200 shadow-md"
        }`}
      >
